...
class StoryDiffusionXLPipeline(StableDiffusionXLPipeline):
        ...
        **kwargs,
        ...
        if not isinstance(pretrained_model_name_or_path_or_dict, dict):
            model_file = _get_model_file(
                ...
                # resume_download=resume_download, #removed to avoid error
                proxies=proxies,
            ...
            print("Loading from safetensors:", model_file)
    ...
    def __call__(
        ...
        if input_id_images is None:
            ...
            prompt_2 = remove_word(prompt, self.trigger_word)
            negative_prompt = remove_word(negative_prompt, self.trigger_word)
            negative_prompt_2 = remove_word(negative_prompt_2, self.trigger_word)
            ...
            return super().__call__(
                ...
                cross_attention_kwargs={"scale": 0.0}, # suppress photomaker adapter
            ...
            return self.generate_id(
                ...
                start_merge_step=start_merge_step, # TODO: change to `style_strength_ratio` in the future
